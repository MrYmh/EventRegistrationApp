...
public static class EventRegistrationAppEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE EventRegistrationAppModuleExtensionConfigurator CLASS (in the Domain.Shared project)
